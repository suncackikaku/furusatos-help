...
![注文管理画面](/src/assets/images/lg_order_01.png)
*注文管理画面*
...
![検索フォーム](/src/assets/images/lg_order_02.png)
*検索フォーム*
...
![注文一覧](/src/assets/images/lg_order_03.png) 
*注文一覧*

検索フォーム下には、注文一覧が表示されます。  
詳細を確認したい注文の **「詳細を見る」** ボタンをクリックすると、詳細画面が確認できます。  

![注文詳細画面（支払済・受け渡し後の場合）](/src/assets/images/lg_order_04.png)
*注文詳細画面（支払済・受け渡し後の場合）*

注文詳細画面では、購入者情報・購入した商品の支払いステータス・商品引き渡しステータス・メモが確認できます。

![注文詳細画面（支払済・受渡前の場合）](/src/assets/images/lg_order_05.png)
*注文詳細画面（支払済・受渡前の場合）*
...
![支払い処理ステータス](/src/assets/images/lg_order_06.png)
*支払い処理ステータス*
...
![商品引き渡し処理ステータス](/src/assets/images/lg_order_07.png)
*商品引き渡し処理ステータス*
...
![注文詳細画面](/src/assets/images/lg_order_08.png)
*注文詳細画面*
...
![キャンセル後の注文一覧画面](/src/assets/images/lg_order_09.png)
*キャンセル後の注文一覧画面*
...
![注文詳細画面](/src/assets/images/lg_order_10.png)
*注文詳細画面*

購入者情報の変更は、注文詳細画面の **「購入者情報を編集する」** から行います。

![編集画面](/src/assets/images/lg_order_11.png)
*編集画面*
...
![注文詳細画面](/src/assets/images/lg_order_12.png)
*注文詳細画面*
...
![注文詳細画面](/src/assets/images/lg_order_13.png)
*注文詳細画面*

注文詳細画面から個別のメモを登録することができます。  
※メモの内容の確認および登録は自治体と店舗双方でできます。

![メモ登録後の画面](/src/assets/images/lg_order_14.png)
*メモ登録後の画面*
